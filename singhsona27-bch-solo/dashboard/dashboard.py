...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        if not self.authorized():
            ...
            self.send_header("WWW-Authenticate", 'Basic realm="BCH Solo Dashboard"')
            self.end_headers()
